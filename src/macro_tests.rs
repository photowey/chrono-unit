...
#[test]
fn test_formatter_macro_format_date_time_utc_default() {
...
#[test]
fn test_formatter_macro_format_naive_date_time_utc_default() {
    let now = "2024-03-12 22:55:00";
    let ndt = NaiveDateTime::parse_from_str(now, "%Y-%m-%d %H:%M:%S").expect("Parse error");
...
#[test]
fn test_formatter_macro_format_naive_date_time_default() {
    let now = "2024-03-12 22:55:00";
    let ndt = NaiveDateTime::parse_from_str(now, "%Y-%m-%d %H:%M:%S").expect("Parse error");
...
#[test]
fn test_formatter_macro_format_date_time_utc() {
    let now = "2024-03-12 22:55:00";
    let ndt = NaiveDateTime::parse_from_str(now, "%Y-%m-%d %H:%M:%S").expect("Parse error");
    let datetime_utc: DateTime<Utc> = Utc.from_utc_datetime(&ndt);
...
#[test]
fn test_formatter_macro_format_naive_date_time_utc() {
    let now = "2024-03-12 22:55:00";
    let ndt = NaiveDateTime::parse_from_str(now, "%Y-%m-%d %H:%M:%S").expect("Parse error");
...
#[test]
fn test_formatter_macro_format_naive_date_time() {
    let now = "2024-03-12 22:55:00";
    let ndt = NaiveDateTime::parse_from_str(now, "%Y-%m-%d %H:%M:%S").expect("Parse error");
